...
map1.on('load', async () => {
    const poi_icon = await map1.loadImage('../icons/point-of-interest6.png');
...
var map4 = new maplibregl.Map({
    ...
    style: 'https://api.maptiler.com/maps/hybrid/style.json?key=IufzbVf2iFVM9b8V7su4', // style URL
    center: [7.96067, 45.15], // starting position [lng, lat]
...
var map5 = new maplibregl.Map({
    ...
    style: 'https://api.maptiler.com/maps/hybrid/style.json?key=IufzbVf2iFVM9b8V7su4', // style URL
    center: [8.1, 45.45], // starting position [lng, lat]
    zoom:8, // starting zoom
    minZoom: 5,
    attributionControl: false,
});
map5.on('load', async () => {
    const poi_icon = await map5.loadImage('../icons/point-of-interest7.png');
...
map7.on('load', async () => {
    ...
    map7.addLayer({"id": "Poi_cicl_7","source": "Poi_cicl_7","type": "symbol","layout": {"icon-image": "poi_icon", "icon-size": 0.05, 'icon-anchor': 'bottom',}});
...
var map15 = new maplibregl.Map({
    ...
    style: 'https://api.maptiler.com/maps/hybrid/style.json?key=IufzbVf2iFVM9b8V7su4', // style URL
    center: [7.6, 45.08], // starting position [lng, lat]
